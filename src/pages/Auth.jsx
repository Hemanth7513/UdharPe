        ...
        <div className="neu-card p-8 sm:p-10">
          ...
          <div className="flex justify-center mb-6">
            <motion.div 
              ...
              className="w-20 h-20 shadow-neu rounded-none flex items-center justify-center text-neu-primary bg-neu-bg border border-4 border-[#059669]"
            >
          ...
          <AnimatePresence>
            {errorMsg && (
              <motion.div 
                ...
                className={`border-4 border-[#059669] bg-white p-4 rounded-none mb-6 text-sm font-bold ${
