    ...
    >
      ...
      <div className="neu-card p-6 sm:p-8 mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 border-4 border-black shadow-none bg-white rounded-none flex items-center justify-center text-neu-primary bg-neu-bg shrink-0">
             <User size={30} />
          </div>
          <div>
        ...
        <div className="text-left md:text-right w-full md:w-auto flex flex-col md:items-end gap-3">
          <div className="p-4 md:p-0 rounded-none md:rounded-none border-4 border-black shadow-none bg-white md:shadow-none bg-neu-bg md:bg-transparent w-full md:w-auto">
      ...
      <div className="space-y-4">
        {transactions.length === 0 ? (
           <div className="neu-card p-10 text-center border-4 border-black shadow-none bg-white border border-4 border-black">
          ...
          transactions.map(t => (
            <div key={t.id} className="neu-card p-5 sm:p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 hover:shadow-neu-hover transition-all">
              <div className="flex items-center gap-4">
                {t.type === 'bill' ? (
                  <div className="w-12 h-12 rounded-none border-4 border-black shadow-none bg-white flex items-center justify-center text-neu-danger bg-neu-bg shrink-0">
                    <ArrowUpRight size={22} />
                  </div>
                ) : (
                  <div className="w-12 h-12 rounded-none border-4 border-black shadow-none bg-white flex items-center justify-center text-neu-success bg-neu-bg shrink-0">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                placeholder="0.00" 
                className="w-full bg-neu-bg text-neu-heading rounded-none pl-12 pr-4 py-4 outline-none focus:ring-2 focus:ring-neu-primary/30 border-4 border-black shadow-none bg-white font-black text-xl"
              />
            </div>
          </div>
          <div>
