...
export default function AdminDashboard() {
  ...
  return (
    ...
    >
      ...
      {error && isAdmin && (
        <div className="bg-neu-danger/10 text-neu-danger p-4 rounded-none font-bold text-sm mb-8 border-4 border-black shadow-none bg-white">
          {error}
        </div>
      )}
      ...
      {stats ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="neu-card p-6 flex flex-col items-center text-center group hover:shadow-neu-hover transition-all border border-neu-primary/20">
            <div className="w-16 h-16 border-4 border-black shadow-none bg-white rounded-none flex items-center justify-center text-neu-primary mb-4 bg-neu-bg">
              <TrendingUp size={28} />
            </div>
      ...
      {stats && (
        <div className="mt-12 bg-neu-bg border-4 border-black shadow-none bg-white rounded-3xl p-8 border border-4 border-black">
      ...
      {stats && stats.businesses && stats.businesses.length > 0 && (
        <div className="mt-8 bg-neu-bg border-4 border-black shadow-none bg-white rounded-3xl p-6 md:p-8 border border-4 border-black overflow-hidden">
