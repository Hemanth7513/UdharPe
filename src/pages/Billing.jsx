...
export default function Billing() {
  ...
  return (
    ...
    >
      ...
      <div className="neu-card p-6 sm:p-10 border border-4 border-black relative z-10">
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              {customers.length === 0 ? (
                <div className="p-4 rounded-none border-4 border-black shadow-none bg-white bg-neu-bg text-neu-danger font-bold text-sm flex justify-between items-center">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-neu-bg text-neu-heading rounded-none px-4 py-4 outline-none focus:ring-2 focus:ring-neu-primary/30 border-4 border-black shadow-none bg-white font-bold"
                  />
                  ...
                  <AnimatePresence>
                    {isDropdownOpen && (
                      <motion.div 
                        ...
                        className="absolute z-50 w-full mt-2 bg-neu-bg border border-4 border-black shadow-neu rounded-none max-h-60 overflow-y-auto"
                      >
