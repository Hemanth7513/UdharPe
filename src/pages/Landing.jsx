  ...
  return (
    <div className="min-h-screen overflow-hidden flex flex-col relative bg-neu-bg">
      ...
      <main className="flex-grow flex items-center justify-center max-w-7xl mx-auto px-6 py-12 w-full z-10">
          ...
          >
            <motion.div variants={itemVariants} className="inline-block px-5 py-2 mb-8 rounded-none border-4 border-[#059669] bg-white text-neu-primary font-bold text-sm tracking-wide bg-neu-bg">
      ...
      >
        <div className="grid md:grid-cols-3 gap-6">
          <div className="flex items-center gap-4 p-5 rounded-none border-4 border-[#059669] bg-white bg-neu-bg">
